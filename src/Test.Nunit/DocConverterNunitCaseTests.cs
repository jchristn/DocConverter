namespace Test.Nunit
{
    ...
    /// <summary>
    /// Reports every DocConverter Touchstone case as an individual NUnit test via TestCaseSource.
    /// </summary>
    [TestFixture]
    public sealed class DocConverterNunitCaseTests
    {
        /// <summary>
        ...
        {
            foreach (TestSuiteDescriptor suite in DocConverterSuites.All)
